<template>
  <form action="" class="login-form" >
      ...
      <div :class="isMobileSwitch" class="registration-switch">
          ...
          <a :class="isMobileButton" class="switch-button" href="#"><div :class="isMobileButton" class="registration-switch-div" ><p :class="isMobileButton" class="registration-switch-text">Зарегистрироваться</p></div></a>
      </div>
    </form>
</template>
